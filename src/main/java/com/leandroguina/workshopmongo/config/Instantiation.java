...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, LocalDate.of(2018, 03, 20), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, LocalDate.of(2018, 03, 22), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
